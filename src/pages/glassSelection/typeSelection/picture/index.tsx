...
import { pictures2 } from '~/util/pictures';
...
const Text: NextPage = () => {
    const [selected, setSelected] = useState<Picture | undefined>(pictures2[0])
                ...
                <div className="w-64 z-20 mt-3 mx-auto sm:mb-0 sm:w-96">
                    {
                        ...
                        <div className='flex items-center'>
                            ...
                            <Dropdown selected={selected} setSelected={setSelected as Dispatch<SetStateAction<Item | undefined>>} items={pictures2} />
                        </div>
                    }
                </div>
